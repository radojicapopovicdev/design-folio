...
const Hero = () => {
  return (
    <div id="hero-wrapper" className="mx-[21.771vw] h-screen z-10">
      ...
      <p className="text-[#454545]/80 w-[22.917vw] absolute ml-[33.542vw] mt-[28vh] font-sansation-regular text-[1.481vh]  ">
        ...
        experience, backed by <span className=""> 1 year </span> of UX/UI Design
        education and <span className=""> 6 months </span>
      ...
      <div id="clouds">
        <img
          src={Cloud1}
          alt="cloud1"
          className="absolute ml-[-10vw] mt-[8vh] w-[4.238vw] h-[4.245vh] "
        />
        <img
          src={Cloud2}
          alt="could2"
          className="absolute ml-[8vw] mt-[3vh] w-[3.794vw] h-[4.554vh] "
        />
        <img
          src={Cloud3}
          alt="cloud3"
          className="absolute ml-[40.885vw] mt-[3vh] w-[3.808vw] h-[4.921vh] "
        />
      </div>
      <div id="pond" className="absolute left-0 right-0 bottom-0 z-20 ">
        {" "}
